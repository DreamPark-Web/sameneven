        ...
        >
          ...
          <button
            ...
            style={{
              width: '100%',
              background: 'var(--s1)',
              border: `1px solid rgba(232,196,154,${isAppleHovered ? '0.65' : '0.4'})`,
              borderRadius: 10,
              color: '#F5F5F5',
              padding: '13px 16px',
              fontSize: 14,
              ...
              marginBottom: 0,
              transition: 'border-color .15s, transform .15s',
              transform: isAppleHovered && !loading ? 'translateY(-1px)' : 'none',
              opacity: loading ? 0.7 : 1,
            }}
          >
            <svg width="17" height="20" viewBox="0 0 814 1000" aria-hidden="true" fill="#F5F5F5">
              <path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-47.4-148.2-97.8C46.6 799.2 6.1 678.4 6.1 563.1c0-189.2 107.5-290 213.9-290 65.3 0 120.9 43.7 162.5 43.7 39.5 0 102.6-46.9 176-46.9 28.6 0 130.3 2.6 198.3 99.2zm-234-181.5c31.1-36.9 53.1-88.1 53.1-139.3 0-7.1-.6-14.3-1.9-20.1-50.6 1.9-110.8 33.7-147.1 75.8-28.5 32.4-55.1 83.6-55.1 135.5 0 7.8 1.3 15.6 1.9 18.1 3.2.6 8.4 1.3 13.6 1.3 45.4 0 102.5-30.4 135.5-71.3z" />
            </svg>
            Inloggen met Apple
          </button>
